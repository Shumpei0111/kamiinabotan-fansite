                                    ...
                                    return (
                                        <li className={style.charaNameList__item} key={c.id}>
                                            <a
                                                ...
                                                href={`#${c.id}`}
                                                onMouseMove={(e) =>
                                                    onCharNameMouseEnterHandler(e, c.imgPath)
                                                }
                            ...
                            {_characters.map((c) => {
                                return (
                                    <div id={c.id} className={style.charaItem} key={c.id}>
                                            ...
                                            <div className={style.charaImage}>
                                                <div className="flex align-item-center">
                                                    <div className={style.charaImage__shadow}>
                                                        <Image
                                                            className={style.charaImage__image}
                                                            src={c.imgPath}
                                                            alt={`引用：「${master.title}」${c.ruby}の画像`}
                                                            objectFit="contain"
                                                            width={200}
                                                            height={300}
                                                        />
                                                    </div>
                                                    <p className={style.charaImage__serif}>
                                                        {c.serif}
                                                    </p>
                                                </div>

                                                <p className={style.charaImage__inyouText}>
                                                    引用：「{master.title}」{c.inyou}
                                                </p>
                                            </div>
                                        ) : (
                                            <></>
                                        ...
                                        <p>
                                            <span className="bold">衣装コンセプト：</span>
                                            <span>{c.clothConcept}</span>
                                        </p>
                                        {c.model ? (
                                            <div className={style.distillery}>
                                                <p className="bold">モデルになった蒸留所</p>
                                                <dl
                                                    className={`flex ${style.distillery__container}`}
                                                >
                                                    <dt className={style.distillery__dt}>
                                                        蒸留所名:
                                                    </dt>
                                                    <dd className={style.distillery__dd}>
                                                        {c.model.name}
                                                    </dd>
                                                ...
                                                <p className="text_ms">
                                                    ※名前の由来から推測した情報です。モデルがあることは明かされていないため、参考情報になります。
                                                </p>
                                            </div>
                                        ) : (
                                            <></>
