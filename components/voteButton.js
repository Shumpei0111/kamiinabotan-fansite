...
export default function VoteButton({ liqourId, putVotedState }) {
    ...
    return (
        <div className={`${style.voteButtonContainer}`}>
            <span
                className={`${style.votedBody} ${style.voteHide} ${isDisplay ? style.voteActive : ''}`}>❤️🍺
            </span>
